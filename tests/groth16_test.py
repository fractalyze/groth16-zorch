...
class TestGroth16Prove(absltest.TestCase):
    ...
    def test_prove_no_zk(self):
        ...
        proof, public_signals = self.compiled.prove(self.wtns, no_zk=True)
    ...
    def test_public_signals(self):
        ...
        _, public_signals = self.compiled.prove(self.wtns, no_zk=True)
    ...
    def test_prove_with_zk(self):
        ...
        proof_no_zk, _ = self.compiled.prove(self.wtns, no_zk=True)
        proof_zk, _ = self.compiled.prove(self.wtns, no_zk=False)
    ...
    def test_proof_json_structure(self):
        ...
        proof, _ = self.compiled.prove(self.wtns, no_zk=True)
        proof_json = proof.to_json()
    ...
    def test_compile_prove_reuse(self):
        ...
        proof1, _ = self.compiled.prove(self.wtns, no_zk=True)
        proof2, _ = self.compiled.prove(self.wtns, no_zk=True)
